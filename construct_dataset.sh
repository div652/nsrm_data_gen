...
python3 get_scenes_json.py --dataset_dir train --split train --out_path scenes-train.json
python3 get_instructions_json.py --dataset_dir train --split train --out_path instructions-train.json

python3 get_scenes_json.py --dataset_dir test --split test --out_path scenes-test.json
python3 get_instructions_json.py --dataset_dir test --split test --out_path instructions-test.json

python3 get_scenes_json.py --dataset_dir val --split val --out_path scenes-val.json
