...
import numpy as np
from  panda.settings import Objects, camera_settings, ColorList
from  panda.construct.program_generator import ProgramGenerator
import random

def construct_main(template_file, metadata_file, fps=120., width=1024, height=768, dataset_dir='dir', objects=None):
  """
  :Parameters:
  ...
  if object_counts is None:
    while True:
      ...
      flag = True
      if "Tray" in objects  and object_counts['num_trays'] > 2:
          continue
